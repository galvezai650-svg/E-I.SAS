        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-gray-500 mb-8 max-w-lg mx-auto">
              Construimos aplicaciones web a la medida de su negocio. Contáctenos y hagamos realidad su próximo proyecto.
            </p>
            <Link
              href="/contacto"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-brand to-brand-dark hover:from-brand-dark hover:to-brand-700 text-white px-8 py-3.5 rounded-full text-sm font-semibold shadow-lg shadow-brand/25 hover:shadow-brand/40 transition-all duration-300 hover:scale-105"
            >
              Contáctenos
